...
class CareerDevelopmentAdvisor(Advisor):
    ...
    def _user_prompt(self) -> str:
        ...
        prompt = (
            ...
            "ücretsiz sertifika/kurs — sağlayıcı, yaklaşık süre, seviye, hangi "
            "beceriyi kazandırdığı ve CV'de nasıl konumlandırılacağı. Ayrıca "
            "dil pratiği için somut bir haftalık rutin (kaynak, günde kaç "
            "dakika, hangi çıktı). Coursera, edX, Khan Academy, freeCodeCamp "
            "gibi bilinen platformların ANA adreslerini kullan; derin URL "
            "uydurma. Her öneriye 'ücretsiz olduğunu doğrulayın' notu ekle.\n\n"
