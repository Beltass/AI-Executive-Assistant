...
class AiInnovationAdvisor(Advisor):
    ...
    def _user_prompt(self) -> str:
        ...
        prompt = (
            ...
            "(d) *⚠️ Sık yapılan hata*: bu konuda yeni başlayanların düştüğü "
            "bir tuzak ve düzeltmesi.\n"
            "Ücretsiz sertifika/kurs listesi VERME — o iş `career_development` "
            "bölümüne aittir ve her gün orada güncelleniyor.\n"
            ...
            "Önümüzdeki 1-3 ay içinde hayata geçirilebilecek 3-4 somut öneri "
            ...
            "ortak kurallardaki 300-500 kelime hedefi BÜTÜN için 450-600 "
