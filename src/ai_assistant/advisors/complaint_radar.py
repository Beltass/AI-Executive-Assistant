...
SYSTEM_PROMPT = (
    ...
    "ODAĞIN ŞİKÂYET VE SENTIMENT: hangi süreç kırılıyor, kurum nasıl yanıt "
    "verince kapanıyor (hizmet telafisi, algılanan adalet, FCR, tekrar "
    "temas). Pazar ve rakip haberlerini yalnızca bu şikâyet tablosunu "
    "AÇIKLADIĞI kadar kullan; bağımsız bir pazar/rekabet analizi yazma — o "
    "`market_intelligence` bölümünün işidir ve tekrarı iki kez ödenir.\n\n"
...
class ComplaintRadarAdvisor(Advisor):
    ...
    def _user_prompt(self) -> str:
        ...
        return (
            ...
            f"{themes}\n\n"
            "*📰 Pazar & rakip yönü*: akıştaki sektör/regülatör haberleri ile "
            "rakip hareketlerini TEK blokta birleştir — bunlar şikâyet "
            "temalarıyla nasıl ilişkili ve kendi markanız bu tabloda nerede "
            "duruyor. Derin pazar/rekabet analizini burada TEKRARLAMA; o iş "
            "`market_intelligence` bölümüne aittir.\n\n"
            "*🏛️ Kurumlar nasıl yanıt veriyor*: gözlenen çözüm yaklaşımı ve "
            "hangi yanıt biçiminin şikâyeti kapattığı, hangisinin büyüttüğü — "
            "hizmet telafisi çerçevesiyle.\n\n"

            "*⚠️ TEHDİT & FIRSAT*: şikâyet + pazar + rakip sinyallerinin "
            "birleşiminden çıkan 2-3 risk/fırsat; hangi KPI'ya (FCR, tekrar "
            "temas, AHT, CES, NPS) ne zaman basınç girebilir.\n\n"
            "*🧭 Operasyon yorumu*: hangi erken uyarı sinyali izlenmeli, hangi "
            "yapısal sorun kalıcı, hangi hızlı kazanç alınabilir. LİSTE DEĞİL, "
            "OPERASYONEL YORUM olsun.\n\n"
